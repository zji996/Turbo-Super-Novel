...
def broadcast_with_shape_check(
...
def broadcast_to_cp_or_tp_ranks(
    ...
    if "attention_mask" in data_batch:
        ...
        data_batch["attention_mask"] = broadcast_with_shape_check(
    ...
    if "padding_mask" in data_batch:
        ...
        data_batch["padding_mask"] = broadcast_with_shape_check(

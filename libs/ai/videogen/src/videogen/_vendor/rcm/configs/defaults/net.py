...
WAN2PT1_1PT3B_T2V_JVP: LazyDict = L(WanModel_JVP)(
    **wan2pt1_1pt3B_net_args, model_type="t2v"
)

WAN2PT1_14B_T2V_JVP: LazyDict = L(WanModel_JVP)(
...
def register_net():
    ...
    cs.store(
        ...
        name="wan2pt1_1pt3B_t2v",
        node=WAN2PT1_1PT3B_T2V,
    )
    cs.store(
        group="net",
        package="model.config.net",
        name="wan2pt1_14B_t2v",
        node=WAN2PT1_14B_T2V,
    )
    cs.store(
        group="net",
        package="model.config.net",
        name="wan2pt1_1pt3B_t2v_jvp",
        node=WAN2PT1_1PT3B_T2V_JVP,
    )
    cs.store(
        group="net",
        package="model.config.net",
        name="wan2pt1_14B_t2v_jvp",
        node=WAN2PT1_14B_T2V_JVP,
    )

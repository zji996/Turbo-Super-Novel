...
class WandbCallback(Callback):
    ...
    def log_to_wandb(
        ...
        to_show = normalized_tensor[
            :actual_n_viz_sample
        ]  # Shape: [actual_n_viz_sample, c, t, h, w]
        ...
        if is_single_frame:
            ...
            print(
                f"Prepared image grid for wandb key '{wandb_key}' with shape {grid_tensor.shape}"
            )
            ...
            print(
                f"Prepared video grid for wandb key '{wandb_key}' with shape {grid_tensor.shape}"
            )

...
_require_dir(ops_dir, hint="Expected sources under libs/turbo_diffusion_ops/csrc")
_require_dir(cutlass_dir / "include", hint="Point CUTLASS_DIR at the CUTLASS repo root")
_require_dir(cutlass_dir / "tools" / "util" / "include", hint="Ensure CUTLASS repo is complete")

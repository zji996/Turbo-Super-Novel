...
class PipelineDefinition:
    ...
    def add_videogen_task(
        self, scene_id: str, depends_on: list[str] | None = None
    ) -> PipelineTask:
...
def build_tts_only_pipeline(
    project_id: str, scene_ids: list[str]
) -> PipelineDefinition:
...
def build_imagegen_only_pipeline(
    project_id: str, scene_ids: list[str]
) -> PipelineDefinition:
